...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '. ᥉ᥙხ᥉ᥴrᎥხᥱ .', url = 't.me/'..Redis:get(TheKdkkkd..'Kdkkkd:Channel:Join')}, },}}
...
if text == (Redis:get(TheKdkkkd.."Kdkkkd:Name:Bot") or "مالوركا") then
